...
- `skillshub tui`: interactive TUI mode as a tap-centric hub for managing taps
  and skills, with batch skill removal (agent symlinks cleaned up
  automatically) and tap deletion directly from the tap list.

### Fixed

- `skillshub link` now replaces dangling agent symlinks instead of leaving them
  broken.
- Upgrade reqwest to 0.12 to resolve h2 RUSTSEC-2026-0258.
